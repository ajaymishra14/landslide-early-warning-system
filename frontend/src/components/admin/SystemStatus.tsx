      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-sm text-white">{health?.service || 'FastAPI Microservice'}</span>
          </div>
          <span className="text-[10px] text-slate-500 font-mono mt-1 block">v{health?.version || '1.0.0'} &bull; Status: {health?.status || 'OK'}</span>
        </div>
        ...
        <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
          ...
          <span className="text-[10px] text-slate-500 font-mono mt-1 block">ORM: SQLAlchemy 2.0 &bull; {health?.database || 'Connected'}</span>
        </div>
        ...
        <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
          ...
          <div className="flex items-center gap-2">
            <span className="w-2.5 h-2.5 rounded-full bg-emerald-500"></span>
            <span className="font-bold text-sm text-white">{health?.ml_engine || 'Calibrated & Loaded'}</span>
          </div>
