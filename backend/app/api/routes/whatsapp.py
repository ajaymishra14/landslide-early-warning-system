...
def authorize(x_operations_key: str=Header(default='')):
    ...
    if not secrets.compare_digest(x_operations_key,settings.OPERATIONS_API_KEY):raise HTTPException(401,'Enter the deployment access key in Field Operations')
